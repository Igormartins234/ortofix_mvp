// global-init.js (COLE ESTE CÓDIGO DENTRO DO ARQUIVO)

document.addEventListener('DOMContentLoaded', () => {
    // Banco de dados de itens (necessário para consulta)
    const allItems = [
        { id: 'theme-default', name: 'Tema Padrão', category: 'tema', themeData: {'--color-primary': '#4A90E2','--color-primary-dark': '#357ABD','--color-background': '#F4F7FA','--color-text-dark': '#2c3e50','--color-text-light': '#8492a6','--color-card-bg': '#ffffff','--color-border': '#e2e8f0'} },
        { id: 'theme-space', name: 'Tema: Espaço Sideral', category: 'tema', themeData: {'--color-primary': '#a855f7','--color-primary-dark': '#9333ea','--color-background': '#0c1427','--color-text-dark': '#e2e8f0','--color-text-light': '#94a3b8','--color-card-bg': '#1a233b','--color-border': '#334155'} },
        { id: 'theme-ocean', name: 'Tema: Fundo do Mar', category: 'tema', themeData: {'--color-primary': '#22d3ee','--color-primary-dark': '#06b6d4','--color-background': '#f0f9ff','--color-text-dark': '#083344','--color-text-light': '#52525b','--color-card-bg': '#ffffff','--color-border': '#bae6fd'} },
        { id: 'theme-forest', name: 'Tema: Natureza', category: 'tema', themeData: {'--color-primary': '#4d7c0f','--color-primary-dark': '#365314','--color-background': '#f0fdf4','--color-text-dark': '#14532d','--color-text-light': '#3f6212','--color-card-bg': '#ffffff','--color-border': '#bbf7d0'} },
